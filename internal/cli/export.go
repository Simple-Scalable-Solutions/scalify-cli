...
large datasets as it has no memory pressure.`,
  ...
  scalify-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  scalify-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  scalify-pp-cli export <resource> --format jsonl | jq '.id'`,
