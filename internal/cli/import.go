...
but do not stop the import.`,
  ...
  scalify-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  scalify-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | scalify-pp-cli import <resource> --input -`,
